...
var POSTPROCESSING = (() => {
    ...
    constructor(colorOutput = false, luminanceRange = null) {
      super({
        ...
        uniforms: {
          ...
          range: new import_three14.Uniform(null)
        },
  ...
  var SSAOMaterial = class extends import_three18.ShaderMaterial {
    constructor(camera) {
      super({
        ...
        uniforms: {
          depthBuffer: new import_three18.Uniform(null),
      ...
      this.toneMapped = false;
      this.adoptCameraSettings(camera);
      this.resolution = new import_three18.Vector2();
      this.r = 1;
    }
    get near() {
      return this.uniforms.cameraNear.value;
    ...
    setDepthBuffer(buffer, depthPacking = import_three18.BasicDepthPacking) {
      this.depthBuffer = buffer;
      this.depthPacking = depthPacking;
    }
  ...
  var Pass = class {
    ...
    set fullscreenMaterial(value) {
      ...
      if (screen !== null) {
        ...
        screen = new import_three19.Mesh(getFullscreenTriangle(), value);
    ...
    setDepthTexture(depthTexture, depthPacking = import_three19.BasicDepthPacking) {
    }
    ...
    dispose() {
      for (const key of Object.keys(this)) {
        ...
        if (property !== null && typeof property.dispose === "function") {
          if (property instanceof import_three19.Scene || property === this.renderer) {
            continue;
          }
          this[key].dispose();
        }
  ...
  var CopyPass = class extends Pass {
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        ...
        } else if (renderer.outputEncoding === import_three20.sRGBEncoding) {
          this.renderTarget.texture.encoding = import_three20.sRGBEncoding;
        }
      }
    }
  };
  ...
  var color = new import_three22.Color();
  ...
  var AUTO_SIZE = -1;
  var Resolution = class extends import_three23.EventDispatcher {
    constructor(resizable, width = AUTO_SIZE, height = AUTO_SIZE, scale = 1) {
      super();
      this.resizable = resizable;
      this.base = new import_three23.Vector2(1, 1);
      this.preferred = new import_three23.Vector2(width, height);
  ...
  var DepthCopyPass = class extends Pass {
    constructor({ depthPacking = import_three27.RGBADepthPacking } = {}) {
      super("DepthCopyPass");
      ...
      this.renderTarget = new import_three27.WebGLRenderTarget(1, 1, {
        type: depthPacking === import_three27.RGBADepthPacking ? import_three27.UnsignedByteType : import_three27.FloatType,
  ...
  var DepthPickingPass = class extends DepthCopyPass {
    constructor({ depthPacking = import_three28.RGBADepthPacking, mode = DepthCopyMode.SINGLE } = {}) {
      super({ depthPacking });
      this.name = "DepthPickingPass";
      this.fullscreenMaterial.mode = mode;
      this.pixelBuffer = depthPacking === import_three28.RGBADepthPacking ? new Uint8Array(4) : new Float32Array(4);
      this.callback = null;
    }
    readDepth(ndc) {
    ...
    render(renderer, inputBuffer, outputBuffer, deltaTime, stencilTest) {
      ...
      if (this.callback !== null) {
        ...
        const packed = renderTarget.texture.type !== import_three28.FloatType;
        let x = 0, y = 0;
  ...
  var BlendMode = class extends import_three29.EventDispatcher {
    constructor(blendFunction, opacity = 1) {
      super();
      this.f = blendFunction;
      this.opacity = new import_three29.Uniform(opacity);
    }
    getOpacity() {
  ...
  var Effect = class extends import_three30.EventDispatcher {
    ...
    dispose() {
      for (const key of Object.keys(this)) {
        const property = this[key];
        if (property !== null && typeof property.dispose === "function") {
          if (property instanceof import_three30.Scene || property === this.renderer) {
            continue;
          }
          this[key].dispose();
        }
...
`;
  ...
  var EffectPass = class extends Pass {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      this.updateMaterial();
      this.verifyResources();
      if (frameBufferType !== void 0 && frameBufferType !== import_three31.UnsignedByteType) {
        this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
      }
    }
    dispose() {
  ...
  var BloomEffect = class extends Effect {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        this.renderTarget.texture.type = frameBufferType;
        if (renderer.outputEncoding === import_three37.sRGBEncoding) {
          this.renderTarget.texture.encoding = import_three37.sRGBEncoding;
        }
      }
    }
  };
  ...
  var DepthOfFieldEffect = class extends Effect {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (renderer.outputEncoding === import_three42.sRGBEncoding) {
          this.renderTarget.texture.encoding = import_three42.sRGBEncoding;
          this.renderTargetNear.texture.encoding = import_three42.sRGBEncoding;
          this.renderTargetFar.texture.encoding = import_three42.sRGBEncoding;
          this.renderTargetMasked.texture.encoding = import_three42.sRGBEncoding;
        }
      }
    }
  };
  ...
  var GlitchEffect = class extends Effect {
    constructor({
      ...
      super("GlitchEffect", shader_default55, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ...
          ["seeds", new import_three46.Uniform(new import_three46.Vector2())],
          ["distortion", new import_three46.Uniform(new import_three46.Vector2())]
        ])
      });
      if (perturbationMap === null) {
        const map = new NoiseTexture(dtSize, dtSize, import_three46.RGBAFormat);
        map.name = textureTag;
    ...
    set perturbationMap(value) {
      ...
      value.minFilter = value.magFilter = import_three46.NearestFilter;
    ...
    generatePerturbationMap(value = 64) {
      const map = new NoiseTexture(value, value, import_three46.RGBAFormat);
      map.name = textureTag;
      return map;
    }
    update(renderer, inputBuffer, deltaTime) {
  ...
  var GodRaysEffect = class extends Effect {
    constructor(camera, lightSource, {
      ...
      this.renderPassLight.clearPass.overrideClearColor = new import_three47.Color(0);
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (renderer.outputEncoding === import_three47.sRGBEncoding) {
          this.renderTargetA.texture.encoding = import_three47.sRGBEncoding;
          this.renderTargetB.texture.encoding = import_three47.sRGBEncoding;
          this.renderTargetLight.texture.encoding = import_three47.sRGBEncoding;
        }
      }
    }
  };
  ...
  var LookupTexture = class extends import_three50.DataTexture3D {
    ...
    applyLUT(lut) {
      ...
      } else if (lut.format !== import_three50.RGBAFormat || this.format !== import_three50.RGBAFormat) {
  ...
  var LUTEffect = class extends Effect {
    ...
    set inputEncoding(value) {
      ...
      if (lut !== null) {
        const outputEncoding = lut.encoding === import_three51.LinearEncoding ? value : lut.encoding;
    ...
    set lut(value) {
      ...
      if (this.lut !== value) {
        ...
        if (value !== null) {
          ...
          if (value.type === import_three51.FloatType || value.type === import_three51.HalfFloatType) {
            defines.set("LUT_PRECISION_HIGH", "1");
          }
          if (image.width > image.height) {
            defines.set("LUT_STRIP_HORIZONTAL", "1");
          } else if (value instanceof import_three51.DataTexture3D) {
    ...
    updateScaleOffset() {
      ...
      if (lut !== null) {
        ...
        if (this.tetrahedralInterpolation && lut instanceof import_three51.DataTexture3D) {
    ...
    constructor(scene, camera, {
      ...
      super("OutlineEffect", shader_default61, {
        uniforms: /* @__PURE__ */ new Map([
          ...
          ["patternScale", new import_three52.Uniform(patternScale)],
    ...
    constructor({ blendFunction = BlendFunction.OVERLAY, density = 1.25, scrollSpeed = 0 } = {}) {
      super("ScanlineEffect", shader_default65, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ...
          ["scrollSpeed", new import_three55.Uniform(0)]
        ])
      });
  ...
  var SelectiveBloomEffect = class extends BloomEffect {
    constructor(scene, camera, options) {
      ...
      depthMaskMaterial.depthPacking1 = import_three57.RGBADepthPacking;
      depthMaskMaterial.depthMode = import_three57.EqualDepth;
    ...
    get inverted() {
      return this.depthMaskMaterial.depthMode === import_three57.NotEqualDepth;
    }
    set inverted(value) {
      this.depthMaskMaterial.depthMode = value ? import_three57.NotEqualDepth : import_three57.EqualDepth;
    }
    isInverted() {
      return this.inverted;
    }
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        this.renderTargetMasked.texture.type = frameBufferType;
        if (renderer.outputEncoding === import_three57.sRGBEncoding) {
          this.renderTargetMasked.texture.encoding = import_three57.sRGBEncoding;
        }
      }
    }
  };
  ...
  var SMAAEffect = class extends Effect {
    constructor({
      ...
      const loadingManager = new import_three59.LoadingManager();
    ...
    constructor(camera, normalBuffer, {
      ...
      super("SSAOEffect", shader_default71, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ...
          ["normalDepthBuffer", new import_three60.Uniform(normalDepthBuffer)],
  ...
  var ToneMappingEffect = class extends Effect {
    constructor({
      ...
      this.renderTargetLuminance = new import_three62.WebGLRenderTarget(1, 1, {
        minFilter: import_three62.LinearMipmapLinearFilter,
